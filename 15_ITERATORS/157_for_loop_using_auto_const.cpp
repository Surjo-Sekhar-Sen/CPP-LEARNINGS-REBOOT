...
int main(){
    int arr[5] = {1, 2, 3, 4, 5};
    for(auto x : arr){//USING auto MEANS WE DON'T NEED TO DECIDE THE DATATYPE!!
        //USING JUST x MEANS IT BASICALLY MAKES A VARIABLE x SEPERATELY WHERE IT COPIES THE ARRAY'S
        //INSTANCE VALUE AT THAT ADDRESS AND SHOWS IT!! SO, IT MEANS WHATEVER WE CHANGE INSIDE THIS LOOP
